...
public class EditCommentWindowBase extends BorderPane {
    ...
    final TextField txtComment;
    protected final Label label;

    public EditCommentWindowBase() {
        ...
        GridPane.setColumnIndex(txtComment, 1);
        txtComment.setAlignment(javafx.geometry.Pos.TOP_LEFT);
        txtComment.setFont(new Font(29.0));
        ...
        gridPane.getChildren().add(txtComment);
